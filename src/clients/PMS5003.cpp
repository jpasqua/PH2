...
void PMS5003::fabricateData(AQIReadings* data) {
  data->standard.pm10 = random(0, 100);
  data->standard.pm25 = random(0, 100);
  data->standard.pm100 = random(0, 100);
  data->env.pm10 = data->standard.pm10 + random(0, 5);
  data->env.pm25 = data->standard.pm25 + random(0, 5);
  data->env.pm100 = data->standard.pm100 + random(0, 5);
